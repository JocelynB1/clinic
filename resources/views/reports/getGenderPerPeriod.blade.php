...
@section('content')
 ...
 <div class="container-fluid">
    <div class="row justify-content-center no-gutters">
        ...
        <div class="card">
                <div class="card-header"><h1>Gender Per Period</h1></div>
        ...
        <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-auto">
                        ...
                        'method' => 'GET',
                        'class'=>"form-inline",                  
                        'action'=>'ReportController@getGenderPerPeriod'
                        ])!!}
                        @csrf
                    ...
                    <div class="col-auto text-right">
                        <a href="{{action('ReportController@getGenderPerPeriod',[
                            'sort'=>'asc',
                            'dateQuery'=>$startDate,
        ...
        <div class="row">
            <h4> Gender Per Period</h4>
                ...
                <div style="width:75%;">
                    ...
                    <div class="row">
            <h4> Total Number Of Patients By Gender</h4>
