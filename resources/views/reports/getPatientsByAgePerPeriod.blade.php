...
@section('content')
 ...
 <div class="container-fluid">
    <div class="row justify-content-center no-gutters">
        ...
        <div class="card">
                <div class="card-header"><h1>Patients By Age Per Period</h1></div>
        ...
        <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-auto">
                        ...
                        'method' => 'GET',
                        'class'=>"form-inline",                  
                        'action'=>'ReportController@getPatientsByAgePerPeriod'
                        ])!!}
                        @csrf
                    ...
                    <div class="col-auto text-right">
                        <a href="{{action('ReportController@getPatientsByAgePerPeriod',[
                            'sort'=>'asc',
                            'dateQuery'=>$startDate,
        ...
        <div class="row">
                <div style="width:75%;">
            <h4> Patients By Age Range</h4>

                        {!! $pieChartjs->render() !!}
                    </div>
            </div>
                    <div class="row">
            <h4>Total Number Of Patients By Age Range</h4>
