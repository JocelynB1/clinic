...
?>
 <div class="container-fluid">
    <div class="row justify-content-center no-gutters">
        ...
        <div class="card">
                <div class="card-header"><h1>All Visits</h1></div>
        ...
        <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-auto">
                        ...
                        <a href="{{action('VisitController@index')}}">Reset</a>
                    </div>
                    <div class="col-auto text-right">
                        <a href="{{action('VisitController@index',['created_at'=>request('created_at'),'sort'=>'asc'])}}">Ascending</a>
                        <a href="{{action('VisitController@index',['created_at'=>request('created_at'),'sort'=>'desc'])}}">Descending</a>
                    </div>
                </div>
                ...
                <table class="table table-striped table-borded table-hover table-sm table-bordered  table-responsive-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            {!! Form::open([
                                'method' => 'DELETE',
                                'action' => ['VisitController@destroy', $record->id]
                                ]) !!}
                            ...
                            {!! Form::open([
                                'method' => 'GET',
                                'action' => ['VisitController@show', $record->id]
                                ]) !!}
                            ...
                            {!! Form::open([
                                'method' => 'GET',
                                'action' => ['VisitController@edit', $record->id]
                                ]) !!}
