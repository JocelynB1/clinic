...
?>
 <div class="container-fluid">
    <div class="row justify-content-center no-gutters">
        ...
        <div class="card">
                <div class="card-header"><h1>All Vitals</h1></div>
            ...
            <?php /*
                <div class="row">
                    <div class="col-auto">
                        ...
                        <a href="{{action('VitalController@index')}}">Reset</a>
                    </div>
                    <div class="col-auto text-right">
                        <a href="{{action('VitalController@index',['created_at'=>request('created_at'),'sort'=>'asc'])}}">Ascending</a>
                        <a href="{{action('VitalController@index',['created_at'=>request('created_at'),'sort'=>'desc'])}}">Descending</a>
                    </div>
                </div>
            */
            ?>
                ...
                <table class="table table-striped table-borded table-hover table-sm table-bordered  table-responsive-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            {!! Form::open([
                                'method' => 'DELETE',
                                'action' => ['VitalController@destroy', $record->id]
                                ]) !!}
                            ...
                            {!! Form::open([
                                'method' => 'GET',
                                'action' => ['VitalController@show', $record->id]
                                ]) !!}
                            ...
                            {!! Form::open([
                                'method' => 'GET',
                                'action' => ['VitalController@edit', $record->id]
                                ]) !!}
